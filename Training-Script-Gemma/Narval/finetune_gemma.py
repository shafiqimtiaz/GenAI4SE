...
def training(train_ds, valid_ds, max_epochs, batch_size):
    ...
    tokenizer = AutoTokenizer.from_pretrained('/home/rraj/projects/def-costa/rraj/GenAI_Project/',
                                              token =HF_TOKEN,
    ...
    model = AutoModelForCausalLM.from_pretrained('/home/rraj/projects/def-costa/rraj/GenAI_Project/',token = HF_TOKEN,
                                                 device_map="auto",
...
def run(data_dir: str, experiment: int = 2, max_epochs: int = 1,
